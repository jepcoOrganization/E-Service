...
{
    [Route("RepairingStatus")]
    [ApiController]
    public class RepairingStatusControllers : ControllerBase
    {
        #region Fields
        ...
        public RepairingStatusControllers(ILoggerManager logger, IRepositoryWrapper repository, IMapper mapper,
        ...
        [Route("AllStutus")]
        public async Task<ActionResult<CommonReturnResult>> GetAllStutus([FromBody] LanguageDto languageDto)
        {
